...
export default function RequestDemo() {
  ...
  return (
    <section id="demo" className={`py-6 bg-gradient-to-br ${colorClasses[primaryColor].gradient} relative overflow-hidden`}>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
        <h2 className="text-3xl sm:text-4xl lg:text-4xl font-semibold text-white mb-6">
